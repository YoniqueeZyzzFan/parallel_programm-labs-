...
data = []
changer = True
data = np.genfromtxt('G:\\Course3\\parallel\\lr3\\Parallel_L3\\x64\\Release\\Data.txt', delimiter=" ", dtype=int)
size = 900
t1 = []
t2 = []
for k in data:
...
data2 = np.genfromtxt('G:\\Course3\\parallel\\lr3\\Parallel_L3\\x64\\Release\\Result.txt', delimiter=" ", dtype=int)
t3 = []
m = []
for k in data2:
    t3.append(k)
